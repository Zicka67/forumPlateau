...
-- Listage des données de la table forumgk.category : ~4 rows (environ)
...
-- Listage des données de la table forumgk.post : ~15 rows (environ)
INSERT INTO `post` (`id_post`, `text`, `datePost`, `user_id`, `topic_id`) VALUES
	...
	(42, 'qzdqzd', '2023-04-05 11:44:17', 12, 23),
	(44, 'USER test', '2023-04-05 11:47:48', 12, 24),
	(54, 'zqdqdqdqdqddq', '2023-04-06 10:30:36', 13, 23),
	(66, 'J&#039;aime les Fraises', '2023-04-06 11:59:08', 13, 3),
	(67, 'J&#039;aime les bananes', '2023-04-06 11:59:30', 13, 2),
	(77, 'zqdd', '2023-04-07 13:49:38', 12, 24),
	(78, 'qddq', '2023-04-07 13:49:40', 12, 24),
	(79, 'qdqzd', '2023-04-07 13:49:57', 12, 38);
...
-- Listage des données de la table forumgk.topic : ~9 rows (environ)
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `category_id`, `user_id`, `closed`) VALUES
	(2, 'Topic Bananes', '2022-02-18 00:00:00', 1, 1, 1),
	(3, 'Topic Fraises', '2021-01-08 00:00:00', 1, 1, 1),
	(4, 'Topic Salades', '2023-03-28 00:00:00', 2, 1, 1),
	(5, 'Topic Tomates', '2020-09-12 00:00:00', 2, 1, 1),
	(11, 'Topic Choux', '2023-04-03 15:33:30', 2, 12, 1),
	(23, 'Topic Viandes', '2023-04-05 11:44:17', 3, 12, 1),
	(24, 'USER test', '2023-04-05 11:47:47', 2, 12, 1),
	(38, 'qdqd', '2023-04-07 13:49:57', 3, 12, 1);
...
INSERT INTO `user` (`id_user`, `pseudo`, `password`, `dateCreate`, `email`, `role`, `status`) VALUES
	...
	(16, 'John', '$2y$10$.KpAb.elaIeDChEuyC08zO44glIcNSrrytsdATnsgT9HH6U5zSMZq', '2023-04-06 09:52:29', 'John@john', 'user', 1);
