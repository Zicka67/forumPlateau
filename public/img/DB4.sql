...
-- Listage des données de la table forumgk.post : ~10 rows (environ)
INSERT INTO `post` (`id_post`, `text`, `datePost`, `user_id`, `topic_id`) VALUES
	...
	(23, 'zdqdqz', '2023-04-04 23:58:18', 13, 2),
	(42, 'qzdqzd', '2023-04-05 11:44:17', 12, 23),
	(43, 'dqdzqd', '2023-04-05 11:44:19', 12, 23),
	(44, 'USER test', '2023-04-05 11:47:48', 12, 24),
	(46, 'zqdzqdqzdq', '2023-04-05 14:33:47', 13, 1),
	(48, 'qzdqzdqzd', '2023-04-05 15:16:46', 12, 27),
	(50, 'zddqzqzdqzd', '2023-04-05 15:32:38', 13, 1),
	(51, 'DeleteAll', '2023-04-05 15:45:34', 2, 28);
...
-- Listage des données de la table forumgk.topic : ~6 rows (environ)
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `category_id`, `user_id`, `closed`) VALUES
	...
	(23, 'qdqdqz', '2023-04-05 11:44:17', 3, 12, 1),
	(24, 'USER test', '2023-04-05 11:47:47', 2, 12, 1),
	(27, 'dzqdzqd', '2023-04-05 15:16:46', 1, 12, 1),
	(28, 'DeleteAll', '2023-04-05 15:44:59', 4, 12, 1),
	(29, 'DeleteAll 2', '2023-04-05 15:45:20', 4, 2, 1);
...
-- Listage des données de la table forumgk.user : ~6 rows (environ)
