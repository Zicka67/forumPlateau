...
-- Listage des données de la table forumgk.category : ~2 rows (environ)
...
-- Listage des données de la table forumgk.post : ~2 rows (environ)
...
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `category_id`, `user_id`, `closed`) VALUES
	(1, 'Topic chien', '2023-03-27 00:00:00', 1, 1, 0),
	(2, 'Topic chat', '2022-02-18 00:00:00', 1, 1, 0),
	(3, 'Topic poisson', '2021-01-08 00:00:00', 1, 1, 0),
	(4, 'Topic tortue', '2023-03-28 00:00:00', 2, 1, 0),
	(5, 'Topic serpent', '2020-09-12 00:00:00', 2, 1, 0);
...
-- Listage des données de la table forumgk.user : ~2 rows (environ)
